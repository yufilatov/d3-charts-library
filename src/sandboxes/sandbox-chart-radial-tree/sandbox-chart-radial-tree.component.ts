...
@Component({
    selector: 'app-sandbox-chart-radial-tree',
    templateUrl: './sandbox-chart-radial-tree.component.html',
    styleUrls: ['./sandbox-chart-radial-tree.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SandboxChartRadialTreeComponent {
