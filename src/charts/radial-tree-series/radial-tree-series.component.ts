...
import { ChartRadialTreeSeriesService } from './radial-tree-series.service';
...
export class RadialTreeSeriesChartComponent implements OnChanges {
    ...
    constructor(private chart: ChartComponent, private seriesService: ChartRadialTreeSeriesService) {
